<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <pattern>
    <rule context="ex13:TS13_FT1">
      ...
      <assert test="count(for $VAR1 in (current()/ex13:rFT1toFT2/* | //*[concat('#',@gml:id)=current()/ex13:rFT1toFT2/@xlink:href]) return $VAR1) = count($A)">ts13_ft1_constraint1: let ft2instances = TS13_FT2.allInstances() in rFT1toFT2-&gt;size() = ft2instances-&gt;size()</assert>
