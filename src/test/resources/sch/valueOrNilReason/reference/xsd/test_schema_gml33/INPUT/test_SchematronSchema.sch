<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <pattern>
    <rule context="ex:DataType">
      <assert test="not(ex:dtAtt) or (count(ex:dtAtt[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:dtAtt/text())) or (count(ex:dtAtt[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:dtAtt/text()) eq count(ex:dtAtt))">If there are elements for property dtAtt, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
    </rule>
    ...
    <rule context="ex:FeatureType1">
      ...
      <assert test="not(ex:attribute3) or (count(ex:attribute3[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:attribute3/@xlink:href)) or (count(ex:attribute3[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:attribute3/@xlink:href) eq count(ex:attribute3))">If there are elements for property attribute3, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
      <assert test="not(ex:attribute4) or (count(ex:attribute4[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:attribute4/@xlink:href)) or (count(ex:attribute4[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:attribute4/@xlink:href) eq count(ex:attribute4))">If there are elements for property attribute4, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
      <assert test="not(ex:attribute5) or (count(ex:attribute5[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:attribute5/@xlink:href)) or (count(ex:attribute5[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:attribute5/@xlink:href) eq count(ex:attribute5))">If there are elements for property attribute5, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
      <assert test="not(ex:attribute6) or (count(ex:attribute6[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:attribute6/@xlink:href)) or (count(ex:attribute6[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:attribute6/@xlink:href) eq count(ex:attribute6))">If there are elements for property attribute6, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
      ...
      <assert test="not(ex:rFT1toObjectType) or (count(ex:rFT1toObjectType[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:rFT1toObjectType/*)) or (count(ex:rFT1toObjectType[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:rFT1toObjectType/*) eq count(ex:rFT1toObjectType))">If there are elements for property rFT1toObjectType, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
    </rule>
    ...
    <rule context="ex:FeatureType2">
      ...
      <assert test="not(ex:propEnumeration) or (count(ex:propEnumeration[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:propEnumeration/text())) or (count(ex:propEnumeration[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:propEnumeration/text()) eq count(ex:propEnumeration))">If there are elements for property propEnumeration, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
      <assert test="not(ex:propInteger) or (count(ex:propInteger[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:propInteger/text())) or (count(ex:propInteger[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:propInteger/text()) eq count(ex:propInteger))">If there are elements for property propInteger, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
    ...
    <rule context="ex:Union">
      <assert test="not(ex:optionA) or (count(ex:optionA[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:optionA/text())) or (count(ex:optionA[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:optionA/text()) eq count(ex:optionA))">If there are elements for property optionA, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
      <assert test="not(ex:optionB) or (count(ex:optionB[@xsi:nil='true' and @*:nilReason]) eq 1 and not(ex:optionB/text())) or (count(ex:optionB[@xsi:nil='true' or @*:nilReason]) eq 0 and count(ex:optionB/text()) eq count(ex:optionB))">If there are elements for property optionB, then either there is only a single such element that is nil, has a nilReason, and no value - or all of these elements are not nil, do not have nilReason attributes, and have values</assert>
    </rule>
