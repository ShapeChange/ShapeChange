<?xml version="1.0" encoding="UTF-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <pattern>
    <rule context="ex1:FeatureTypeS1_2">
      ...
      <assert test="not(iso:att2/*) or iso:att2/*[local-name()='CodeListS2' and namespace-uri()='http://example.org/shapechange/sch/codelist2/codeListRestriction/1']">att2_is_CodeListS2:  The type of att2 is restricted to CodeListS2. </assert>
    </rule>
