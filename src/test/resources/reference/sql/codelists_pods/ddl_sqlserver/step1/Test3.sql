...
ALTER TABLE T3_CodeList1 ADD CONSTRAINT fk_T3_CodeL_T3_Sourc_SOURCE_C FOREIGN KEY (SOURCE_CL) REFERENCES T3_SourceCL;
...
ALTER TABLE T3_CodeList2 ADD CONSTRAINT fk_T3_CodeL_T3_Sourc_SOURCE_C0 FOREIGN KEY (SOURCE_CL) REFERENCES T3_SourceCL;
...
INSERT INTO T3_CodeList1 (CODE, DESCRIPTION, NAME, ACTIVE_INDICATOR_LF, SOURCE_CL) VALUES ('1', 'code1', '', 'Yes', NULL);
INSERT INTO T3_CodeList1 (CODE, DESCRIPTION, NAME, ACTIVE_INDICATOR_LF, SOURCE_CL) VALUES ('2', 'code2', '', 'Yes', NULL);
INSERT INTO T3_CodeList1 (CODE, DESCRIPTION, NAME, ACTIVE_INDICATOR_LF, SOURCE_CL) VALUES ('quote''me', 'code3', '', 'Yes', NULL);
INSERT INTO T3_CodeList2 (CODE, DESCRIPTION, NAME, ACTIVE_INDICATOR_LF, SOURCE_CL) VALUES ('code''B', 'code''B', 'codeB definition', 'Yes', NULL);
INSERT INTO T3_CodeList2 (CODE, DESCRIPTION, NAME, ACTIVE_INDICATOR_LF, SOURCE_CL) VALUES ('codeA', 'codeA', 'codeA''s definition', 'Yes', NULL);
