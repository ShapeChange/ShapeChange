...
ALTER TABLE T3_CLASS1 ADD CONSTRAINT FK_T3_CLASS_T3_CODEL_P3_FK FOREIGN KEY (P3_FK) REFERENCES T3_CODELIST;
...
ALTER TABLE T6_CLASS1 ADD CONSTRAINT FK_T6_CLASS_T6_CLASS_P1_FK FOREIGN KEY (P1_FK) REFERENCES T6_CLASS2;
...
INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES ('T1_CLASS2', 'P', MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('dim1', -1, 1, 0.1), MDSYS.SDO_DIM_ELEMENT('dim2', -2, 2.2, 0.2), MDSYS.SDO_DIM_ELEMENT('dim3', -3, 3, 0.05)), 31467);
INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES ('T1_CLASS3', 'P', MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('dim1', -1, 1, 0.1), MDSYS.SDO_DIM_ELEMENT('dim2', -2, 2.2, 0.2), MDSYS.SDO_DIM_ELEMENT('dim3', -3, 3, 0.05)), 31467);
INSERT INTO USER_SDO_GEOM_METADATA (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES ('T3_CLASS1', 'P1', MDSYS.SDO_DIM_ARRAY(MDSYS.SDO_DIM_ELEMENT('dim1', -1, 1, 0.1), MDSYS.SDO_DIM_ELEMENT('dim2', -2, 2.2, 0.2), MDSYS.SDO_DIM_ELEMENT('dim3', -3, 3, 0.05)), 31467);
