...
ALTER TABLE featuretype1_feature1b_target ADD CONSTRAINT fk_featuretype1_feature1b_target_featuretype1_feature1b_source_id FOREIGN KEY (featuretype1_feature1b_source_id) REFERENCES featuretype1;
ALTER TABLE featuretype1_feature1b_target ADD CONSTRAINT fk_featuretype1_feature1b_target_featuretype1_feature1b_target_id FOREIGN KEY (featuretype1_feature1b_target_id) REFERENCES featuretype1;
