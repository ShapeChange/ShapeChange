...
ALTER TABLE FEATURETYPE1_ROLEFT1A ADD CONSTRAINT FK_FEATURETYPE1_ROLEFT1A_FEAT0 FOREIGN KEY (FEATURETYPE2_ID) REFERENCES FEATURETYPE2 DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE FEATURETYPE1_ROLEFT1A ADD CONSTRAINT FK_FEATURETYPE1_ROLEFT1A_FEATU FOREIGN KEY (FEATURETYPE1_ID) REFERENCES FEATURETYPE1 DEFERRABLE INITIALLY IMMEDIATE;
