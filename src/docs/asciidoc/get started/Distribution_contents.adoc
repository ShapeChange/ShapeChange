...
|test/test.eap |Test model in Enterprise Architect format. This
is a copy of https://shapechange.net/resources/test/test.eap.
|===
...
|https://shapechange.net/resources/test/test.eap[test/test.eap]
