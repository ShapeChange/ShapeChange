...
Practices] and the https://github.com/opengeospatial/WFS_FES[draft OGC
...
https://docs.docker.com/docker-for-mac/networking/#use-cases-and-workarounds[where
...
See the
http://interactive-instruments.github.io/ldproxy/book/07-security.html[ldproxy
...
http://localhost:7080/rest/services.

To change the external URL of a service, see the
http://interactive-instruments.github.io/ldproxy/book/09-webserver.html[ldproxy
...
http://interactive-instruments.github.io/ldproxy/book/08-logging.html[ldproxy
documentation].
