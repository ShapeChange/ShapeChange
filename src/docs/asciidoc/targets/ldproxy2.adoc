...
*** NOTE: The ldproxy target will log a warning if a code/enum has a blank value for the tag _ldpCodeTargetValue_, and proceed by using the enum / code name as {target_value}.
