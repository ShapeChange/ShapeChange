...
*[red]#DEPRECATED#* - The conversion to JSON Schema has been revised. The xref:./JSON_Schema.adoc[new version]
...
https://datatracker.ietf.org/doc/html/draft-zyp-json-schema-03#autoid-35):
...
_\https://example.com/TDS/FeatureServer/1/\{objectId}?f=json_ and
_\https://example.com/TDS/FeatureServer/2/\{objectId}?f=json_
...
_\http://json-schema.org/draft-04/schema#_
