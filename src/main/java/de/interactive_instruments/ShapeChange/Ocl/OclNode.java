...
/**
 * <p>OclNodes stand for the syntactic constructs of the supported subset of 
 * OCL in this package. They form a complete description of the OCL particles
 * and their relation to the UML model.</p>
 * <p>OclNode itself is abstract and stands for an OCL expression expressed by
 * roughly in 5 flavors, namely:</p>
 * <ul>
 ...
 * <li><i>PropertyCallExp</i> - selecting an attribute/operation in the UML model or 
 * built-in. Concrete flavors are <i>AttributeCallExp</i>, <i>OperationCallExp</i> 
 * and <i>IteratorCallExp</i>. 
 * </ul> 
 * <p>Additionally there is:</p>
 * <ul>
 * <li><i>Expression</i> - which stands for a full blown OCL expression including 
 * context and constraint type and name and all, and
 ...
 * </ul>
 * <p>All OclNodes carry a datatype, which is either built-in or from the UML
 * model.<p>
 * <p>Use OclNodes by directly accessing their public fields.
 * 
 * @version 0.1
...
public abstract class OclNode {
	...
	static final HashMap<String,BuiltInType> iso19103Map = 
		new HashMap<String,BuiltInType>();
	static {
	...
	static public BuiltInType iso19103AssumedBuiltInType( ClassInfo ci ) {
		...
		if( scids!=null ) {
			for( String scid : scids ) {
				...
				if( sci!=null ) {
					BuiltInType sbit =
						iso19103AssumedBuiltInType( sci );
					if( sbit!=null )
						return sbit;
				}
			}
	...
	static public class BuiltInDescr {
		...
		BuiltInDescr( 
			String name, BuiltInType applType, BuiltInType[] arguTypes,
			int noOfDecls, boolean arrow, MultiplicityMapping multMap,
			BuiltInType resType ) {
			this( name, applType, arguTypes, noOfDecls, arrow, 
				multMap, resType, 0);
		}
		BuiltInDescr( 
			String name, BuiltInType applType, BuiltInType[] arguTypes,
			int noOfDecls, boolean arrow, MultiplicityMapping multMap,
			BuiltInType resType, int specialTreatment ) {
			this.name = name;
	...
	static BuiltInDescr [] builtInDescriptors = {
		...
		new BuiltInDescr( "allInstances", BuiltInType.CLASS, null, 0, false,
				MultiplicityMapping.ONE2MANY, BuiltInType.UMLTYPE, 1 ),
		new BuiltInDescr( "size", BuiltInType.ANY, null, 0, true,
				MultiplicityMapping.MANY2ONE, BuiltInType.INTEGER ),
		new BuiltInDescr( "isEmpty", BuiltInType.ANY, null, 0, true,
				MultiplicityMapping.MANY2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "notEmpty", BuiltInType.ANY, null, 0, true,
				MultiplicityMapping.MANY2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "exists", BuiltInType.ANY, 
				new BuiltInType[]{BuiltInType.BOOLEAN}, 1, true,
				MultiplicityMapping.MANY2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "forAll", BuiltInType.ANY, 
				new BuiltInType[]{BuiltInType.BOOLEAN}, 1, true,
				MultiplicityMapping.MANY2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "isUnique", BuiltInType.ANY,
				new BuiltInType[]{BuiltInType.ANY}, 1, true,
				MultiplicityMapping.MANY2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "select", BuiltInType.ANY, 
				new BuiltInType[]{BuiltInType.BOOLEAN}, 1, true,
				MultiplicityMapping.MANY2MANY, BuiltInType.ANY, 2 ),
		new BuiltInDescr( "size", BuiltInType.STRING, null, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.INTEGER ),
		new BuiltInDescr( "substring", BuiltInType.STRING, 
				new BuiltInType[]{BuiltInType.INTEGER,BuiltInType.INTEGER}, 
				0, false, MultiplicityMapping.ONE2ONE, 
				BuiltInType.STRING, 4 ),
		new BuiltInDescr( "concat", BuiltInType.STRING, 
				new BuiltInType[]{BuiltInType.STRING}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.STRING, 4 ),
		new BuiltInDescr( "matches", BuiltInType.STRING, 
				new BuiltInType[]{BuiltInType.STRING}, 0, false, 
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN, 4 ),
		new BuiltInDescr( "oclIsKindOf", BuiltInType.ANY, 
				new BuiltInType[]{BuiltInType.CLASS}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "oclIsTypeOf", BuiltInType.ANY, 
				new BuiltInType[]{BuiltInType.CLASS}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
	...
	static BuiltInDescr [] operSymbDescriptors = {
		...
		new BuiltInDescr( "or", BuiltInType.BOOLEAN, 
				new BuiltInType[]{BuiltInType.BOOLEAN}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "xor", BuiltInType.BOOLEAN, 
				new BuiltInType[]{BuiltInType.BOOLEAN}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "and", BuiltInType.BOOLEAN, 
				new BuiltInType[]{BuiltInType.BOOLEAN}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "implies", BuiltInType.BOOLEAN, 
				new BuiltInType[]{BuiltInType.BOOLEAN}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "not", BuiltInType.BOOLEAN, null, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),

		new BuiltInDescr( "-", BuiltInType.INTEGER, null, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.INTEGER ),
		new BuiltInDescr( "-", BuiltInType.REAL, null, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.REAL ),
				
		new BuiltInDescr( "+", BuiltInType.INTEGER, 
				new BuiltInType[]{BuiltInType.INTEGER}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.INTEGER ),
		new BuiltInDescr( "+", BuiltInType.INTEGER, 
				new BuiltInType[]{BuiltInType.REAL}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.REAL ),
		new BuiltInDescr( "+", BuiltInType.REAL, 
				new BuiltInType[]{BuiltInType.REAL}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.REAL ),
		new BuiltInDescr( "+", BuiltInType.REAL, 
				new BuiltInType[]{BuiltInType.INTEGER}, 0, false,
		...
		new BuiltInDescr( "=", BuiltInType.ANY, 
				new BuiltInType[]{BuiltInType.ANY}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( "<>", BuiltInType.ANY, 
				new BuiltInType[]{BuiltInType.ANY}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
		...
		new BuiltInDescr( "<", BuiltInType.DATE, 
				new BuiltInType[]{BuiltInType.DATE}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
		new BuiltInDescr( ">", BuiltInType.DATE, 
				new BuiltInType[]{BuiltInType.DATE}, 0, false,
				MultiplicityMapping.ONE2ONE, BuiltInType.BOOLEAN ),
	...
	public static class DataType {
		 ...
		 * ClassInfo object.</p>
		 * <p>The Ctor automatically finds out, if the class is one of those
		...
		public DataType( ClassInfo ci ) {
			...
			if( bi!=null ) builtInType = bi;
		}
		
		/**
		 * <p>Initialize a DataType from an explicit BultInType enum value. 
		...
		/**
		 * <p>Initialize a DataType from its name alone. This may create
		 * a pure OCL type (if it belongs to the set of OCL Types), or
		 * may represent one of the well-known 19103 types mapped to OCL,
		 * or may represent some UML class from which we only know the 
		 * name.</p>
		...
		/**
		 * Determine common supertype of this type and the one given. If no such
		 * type can be determined null is returned.
		 * @param type Type to be analyzed as indicated
		...
		public DataType commonSuperType( DataType type ) {
			...
			if( isBuiltIn() ) {
				...
				// Check for common supertype ...
				searchloops:
				for( ClassInfo ci1=umlClass; ci1!=null; ci1=ci1.baseClass() ) {
					for( ClassInfo ci2=type.umlClass; ci2!=null; 
						 ci2=ci2.baseClass() ) {
						if( ci1==ci2 ) {
							sci = ci1;
							break searchloops;
	...
	/**
	 * <p>The method debugPrint outputs the content of an OclNode for
	...
	/**
	 * <p>This is for generating debug output out of OclNodes.
	 * @param streamPrint Writer onto which the debug output is to be directed.
	 */
	...
	/**
	 * <p>Inquire the DataType of the OclNode.</p>
	 * @return DataType
	 */
	...
	/**
	 * <p>Find out whether this is OclNode is of an OCL built-in datatype.
	...
	/** 
	 * <p>Find out whether this OclNode represents a multiple entity, such as
	 * a Set or other Collection type.</p>
	...
	/**
	 * <p>OclNode.OclExpression wraps a complete OCL expression classifying it
	 * as either an invariant or an expression of the derive/init type.</p>
	 */
	public static class Expression extends OclNode {
		...
		/**
		 * Construct an OclExpression from name, type of expression and
		 ...
		 */
		Expression( 
			String name, OclConstraint.ConditionType et, OclNode exp, 
			OclNode.Declaration self, 
	...
	/**
	 * <p>LiteralExp is the common root of all implemented OCL literal 
	...
	public static abstract class LiteralExp extends OclNode {
		...
		/**
		 * <p>The implementations of this abstract function return the value 
		 * of the literal as a String.</p> 
	...
	/**
	 * <p>A RealLiteralExp OclNode represents a real value.</p> 
	 */
	...
	/**
	 * <p>A IntegerLiteralExp OclNode represents an integer value.</p> 
	 */
	...
	/**
	 * <p>A StringLiteralExp OclNode represents a String value.</p> 
	 */
	...
	/**
	 * <p>A BooleanLiteralExp OclNode represents a boolean value.</p> 
	 */
	...
	/**
	 * <p>A DateTimeLiteralExp OclNode represents a defined date and time or
	 * if constructed without a parameter the current date and time.</p> 
	 */
	...
	/**
	 * <p>A OclVoidLiteralExp OclNode represents the 'null' item, which is of
	 * type OclVoid.</p> 
	 */
	...
	/**
	 * <p>A ClassLiteralExp OclNode represents a class from the model. Note that
	 * the values of a ClassLiteralExp are classes not instances.</p> 
	 */
	...
	/**
	 * <p>A PackageLiteral OclNode represents a UML package. Note that objects
	 * of this class are created only temporarily in the process of resolving
	 * qualified names.</p> 
	 */
	...
	/**
	 * <p>Objects of this class represent the declaration of variables in some
	 * context, such as a let-expression or an iterator reference. Declaration 
	 * objects are also created implicitly, for example to represent the 
	 * non-explicitly declared binding variable of an iterator.</p>
	 * <p>There will always be an implicitly created Declaration object for the
	 * <i>self</i> variable, which is attached to the outmost expression scope.
	 * Declaration objects have a reference to their surrounding Declaration.
	 * By walking this queue all variables explicitly or implicitly in effect
	 * for a place in the syntax tree, can always be determined.</p>   
	 */
	public static class Declaration extends OclNode {
		 ...
		 */
		public Declaration( 
			String name, DataType dt, OclNode ival, Declaration declCtx, 
			OclNode owner, boolean impl ) {
	...
	/**
	 * <p>VariableExp objects stand for an instance of a variable in some 
	 * expression. The variable is always associated with a single 
	 * Declaration object, which defines the meaning of a variable.</p>
	 * <p>Note that all access paths to model contents start with a VariableExp, mostly 
	 * <i>self</i>.</p>   
	 */
	...
	/**
	 * <p>OclNode.IfExp stands for an if-then-else-endif construct. It is 
	 * ensured that the condition part is of type BOOLEAN and that both decision
	 * parts are of compatible types, least abstract supertype of which will be
	 * the type of the IfExp.</p>
	 */
	...
	/**
	 * <p>OclNode.LetExp represents a let-construct. It is ensured that all
	 * contained declarations exhibit a type and a value.</p>
	 */
	...
	/**
	 * <p>Objects of class OclNode.PropertySelector stand for selecting and 
	...
	public static class PropertySelector {
		...
		/**
		 * This Ctor initializes any form of non-UML PropertySelector. The
		 * Category and name have to be explicitly specified.
		 * @param pc Property category. Must not be one of the UML-categories.
		 * @param name Name of the property.
		 */
		PropertySelector( 
			PropertyCategory pc, String name ) {
			category = pc;
			this.name = name;
		}
	}
	...
	/**
	 * <p>The abstract class OclNode.CallExp stands for a selector step, which
	 * is applied to some object or set of objects. Syntactically, in OCL this
	 * is the construct <i>object.selector</i> or <i>object->selector</i>, 
	 * optionally followed by an argument list. Note that the object part can
	 * also be implicit, due to a left out <i>self</i> or iterator binding
	 * variable.</p>  
	 */
	public abstract static class PropertyCallExp extends OclNode {
		...
		public boolean isMultiple() {
			return 
				multMapping==MultiplicityMapping.MANY2MANY ||
	...
	/**
	 * <p>OclNode.AttributeCallExp stands for an OCL construct of the form
	 * <i>object.selector</i>, where the <i>object</i> can be any object or
	 * built-in type valued construct and <i>selector</i> selects some specific
	...
	/**
	 * <p>OclNode.OperationCallExp stands for an OCL construct of the form
	 * <i>object.selector(arg1,...)</i>, where the <i>object</i> can be any 
	 * object or built-in type valued construct, <i>selector</i> selects some 
	 * specific operation from that resource and <i>(arg1,...)</i> stands for 
	 * a list of zero or more argument expressions.
	 */
	public static class OperationCallExp extends PropertyCallExp {
		 ...
		 */
		OperationCallExp( 
			OclNode o, OperationInfo oi, OclNode[] args, boolean im ) {
			object = o;
		 ...
		 */
		OperationCallExp( 
			OclNode o, boolean setLevel, String name, OclNode[] args, 
			DataType type, MultiplicityMapping mm, boolean imp ) {
			object = o;
			dataType = type;		
			if( o instanceof OclNode.ClassLiteralExp )
				selector = 
					new PropertySelector( PropertyCategory.CLASSOPER, name );
			else if( setLevel ) {
				selector =
					new PropertySelector( PropertyCategory.SETOPER, name );
			} else if( o.isBuiltInType() )
				selector =
					new PropertySelector( PropertyCategory.BASEOPER, name );
			else
				selector =
					new PropertySelector( PropertyCategory.UMLADDOPER, name );
			multMapping = mm;
			isImplicit = imp;
			arguments = args;
		}
	...
	/**
	 * <p>OclNode.IterationCallExp stands for an OCL construct of the form
	 * <i>object.selector(var1,...|arg1,...)</i>, where the <i>object</i> can
	 * be any object or built-in type valued construct, <i>selector</i> selects 
	 * some specific iterative operation from that resource and 
	...
	public static class IterationCallExp extends OperationCallExp {
		 ...
		 */
		IterationCallExp( 
			OclNode o, String name, Declaration[] decls, OclNode[] args, 
			DataType type, MultiplicityMapping mm ) {
