 ...
 *
 */
public enum EADirection {

	UNSPECIFIED("Unspecified"), BIDIRECTIONAL(
			"Bi-Directional"), SOURCE_DESTINATION(
					"Source -> Destination"), DESTINATION_SOURCE(
							"Destination -> Source");

	private final String eaValue;

	EADirection(String eaValue) {
