...
public interface DatabaseStrategy {
    ...
    /**
     *
     * @param me   map entry in configuration file
     * @param srid defined in configuration file
     * @return (complex) database data type to be used as data type for the geometry
     *         column
     */
     ...
     * @param table                   tbd
     * @param column                  tbd
     * @param geometryCharacteristics additional geometry specific characteristics -
     ...
     * @param srid                          tbd
     * @return update statement; may be <code>null</code> if this operation is not
     *         applicable to the actual database strategy
     */
     ...
     * characteristics) defined by the map entries declared for the SQL DDL target.
     * 
     ...
     * this check has already been performed), create an expression to restrict the
     * field (i.e., the given column representing the property) in case that the
     * data type of the field also stores time. In such a situation, ensure that the
     * time stored in the field is always 00:00:00. Example: the value type of the
     * property is (ISO 19103) "Date" and the type of the database field is Oracle
     * DATE (which stores both date and time).
     * 
     * @param column tbd
     * @return the expression to restrict time of date, or <code>null</code> if this
     *         is not necessary (or not implemented; check the actual database
    ...
    /**
     * @param schemaNames names of the database schemas that shall be created
     * @return statements to initialize the database schemas; can be empty but not
     *         <code>null</code>
     */
