 ...
 *
 */
public class LowerCaseNameWithLimitedLengthNormalizer extends LowerCaseNameNormalizer implements MessageSource {

    protected ShapeChangeResult result;
    protected int maxLength;

    public LowerCaseNameWithLimitedLengthNormalizer(ShapeChangeResult result, int maxLength) {
	this.result = result;
