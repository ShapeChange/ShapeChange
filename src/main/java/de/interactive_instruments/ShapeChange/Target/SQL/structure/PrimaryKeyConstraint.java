...
public class PrimaryKeyConstraint extends UniqueConstraint {
	...
	public PrimaryKeyConstraint(String name, List<Column> columns,
		...
		super(name, columns, indexSpecification);
	}

	public PrimaryKeyConstraint(String name, Column column,
			String indexSpecification) {

		super(name);
		addColumn(column);
		setIndexSpecification(indexSpecification);
	}
