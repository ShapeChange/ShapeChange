...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="fc.Derived"><xsl:value-of select="$localizationMessages/messages/message[@id='fc.Derived']/text[contains(@lang,$lang)]"/></xsl:variable>
  ...
  <xsl:variable name="fc.InitialValue"><xsl:value-of select="$localizationMessages/messages/message[@id='fc.InitialValue']/text[contains(@lang,$lang)]"/></xsl:variable>
  <xsl:variable name="fc.Language"><xsl:value-of select="$localizationMessages/messages/message[@id='fc.Language']/text[contains(@lang,$lang)]"/></xsl:variable>
  <xsl:variable name="fc.LegalBasis"><xsl:value-of select="$localizationMessages/messages/message[@id='fc.LegalBasis']/text[contains(@lang,$lang)]"/></xsl:variable>
