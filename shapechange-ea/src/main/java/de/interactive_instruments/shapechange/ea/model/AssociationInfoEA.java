...
import de.interactive_instruments.shapechange.core.model.AssociationInfoImpl;
...
public class AssociationInfoEA extends AssociationInfoImpl implements AssociationInfo {
	...
	navigability = EAConnectorUtil.navigability(eaConnector);
...
//	}
	...
	if (ls.isEmpty()) {
		...
		if (model().descriptorSource(Descriptor.GLOBALIDENTIFIER).equals("ea:guidtoxml")) {
		    ...
		    String gi = document.repository.GetProjectInterface().GUIDtoXML(eaConnector.GetConnectorGUID());
