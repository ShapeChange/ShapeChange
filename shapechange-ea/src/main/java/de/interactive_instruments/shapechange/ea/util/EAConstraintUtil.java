...
public class EAConstraintUtil extends AbstractEAUtil {
	...
	return switch (mnr) {
	case 101 -> "EA error encountered while updating 'Notes' of EA constraint '$1$'. Error message is: $2$";
	case 102 -> "EA error encountered while appending to 'Notes' of EA constraint '$1$'. Error message is: $2$";
	default -> "(" + EAConstraintUtil.class.getName() + ") Unknown message with number: " + mnr;
	};
    }
}
