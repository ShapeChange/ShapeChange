 ...
 *
 */
public class TaggedValueEaInputTransformerConfigurationValidator extends AbstractConfigurationValidator {
	...
	if (this.config instanceof InputTransformerConfiguration trfConfig) {
		...
		for (TaggedValueConfigurationEntry tvce : taggedValues) {
			...
			isValid = false;
			result.addError(this, 100, trfConfig.getClassName(), e.getMessage());
		    }
		}
	    }
	}
	...
	case 100 -> "Invalid model element selection criteria in TaggedValue element. Details: $2$";
