...
import de.interactive_instruments.shapechange.core.ocl.OclNode.BuiltInType;
...
import de.interactive_instruments.shapechange.core.ocl.OclNode.PropertyCallExp;
import de.interactive_instruments.shapechange.core.ocl.OclNode.VariableExp;
	...
	static class Expression extends TempNode {
		...
		OclNode connectToModel(OclParser p, Model model,
			...
			if (et == OclConstraint.ConditionType.INVARIANT) {
				...
				de.interactive_instruments.shapechange.core.Type ptype = pi
						.typeInfo();
