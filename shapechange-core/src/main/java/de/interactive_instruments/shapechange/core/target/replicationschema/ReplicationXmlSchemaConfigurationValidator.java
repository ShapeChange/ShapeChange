 ...
 *
 */
public class ReplicationXmlSchemaConfigurationValidator extends AbstractConfigurationValidator {

    protected SortedSet<String> allowedParametersWithStaticNames = new TreeSet<>(
	    Stream.of(ReplicationXmlSchema.PARAM_OBJECT_IDENTIFIER_FIELD_NAME, ReplicationXmlSchema.PARAM_SIZE,
