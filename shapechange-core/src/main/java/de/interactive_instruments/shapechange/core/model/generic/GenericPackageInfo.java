...
public class GenericPackageInfo extends PackageInfoImpl implements MessageSource {
    ...
    /**
     * 
     * @see de.interactive_instruments.shapechange.core.model.PackageInfo#containedPackages
     *      ()
     */
    @Override
    ...
    /**
     * Provides the set of all packages in the package tree where this package is
     * the head. This package is also added to the set.
     * 
     * @param set tbd
     * @return tbd
     */
     ...
     * @param tvName       tbd
     * @param tvValue      tbd
     * @param updateFields true if package fields should be updated based upon
	...
	/*
	 * TODO updateFields currently ignored - see setTaggedValues code for furhter
	 * info
	 */
    }
...
//			for (String key : taggedValuesCache.keySet()) {
	    ...
	    /*
	     * We don't set targetNamespace, version, xmlns, and xsdDocument explicitly.
	     * This information should be stored in tagged values.
	     */
...
//			}
    ...
    /**
     * Sets the target namespace for this package (by setting the according tagged
     * value).
     * 
    ...
    /**
     * Sets the version for this package (by setting the according tagged value).
     * 
     * @param version tbd
     */
    ...
    /**
     * Sets the xmlns for this package (by setting the according tagged value).
     * 
     * @param xmlns tbd
     */
    ...
    /**
     * Sets the xsdDocument for this package (by setting the according tagged
     * value).
     * 
	...
	if (childPi == null || childPi.isEmpty()) {
		...
		if (child instanceof GenericPackageInfo info) {
		    ...
		    /*
		     * Alright, we have encountered a child which is not one of the selected schema.
		     * The way this method works, we cannot analyze such a package. We need to
		     * assume that it is not empty.
		     */
		}
	    }

	    if (containerForEmptyPackages.containsAll(childPi) && (classes == null || classes.isEmpty())) {
    ...
    /**
     * Removes the given class info from the set of class infos for this package.
     * 
     * @param ciToRemove
     */
    ...
    /**
     * Adds the prefix to the 'id' of this package as well as the 'schemaId' (if not
     * <code>null</code>) and the 'supplierIds' (if not <code>null</code>).
     * 
