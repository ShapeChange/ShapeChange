 ...
 *
 */
public class GeometryPropertyDefinition extends AbstractPropertyDefinition {
    ...
    /**
     * @param geometryType the geometry type to set
     */
    ...
    @Override
    public GeometryPropertyDefinition createCopy() {

	GeometryPropertyDefinition copy = new GeometryPropertyDefinition();
