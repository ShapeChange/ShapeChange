...
public class FeatureCatalogueConfigurationValidator extends AbstractConfigurationValidator {
    ...
    protected SortedSet<String> allowedParametersWithStaticNames = new TreeSet<>(Stream.of(
	    ...
	    FeatureCatalogue.PARAM_INCLUDE_DIAGRAMS, FeatureCatalogue.PARAM_INCLUDE_DIAGRAM_DOCUMENTATION,
	    FeatureCatalogue.PARAM_INCLUDE_TITLE, FeatureCatalogue.PARAM_INCLUDE_VOIDABLE,
	    FeatureCatalogue.PARAM_INHERITED_CONSTRAINTS, FeatureCatalogue.PARAM_INHERITED_PROPERTIES,
	    FeatureCatalogue.PARAM_JAVA_EXE_PATH, FeatureCatalogue.PARAM_JAVA_OPTIONS, FeatureCatalogue.PARAM_LANG,
	    FeatureCatalogue.PARAM_LOCALIZATION_MESSAGES_URI, FeatureCatalogue.PARAM_LOGO_FILE_PATH,
	    FeatureCatalogue.PARAM_NAME, FeatureCatalogue.PARAM_NO_ALPHABETIC_SORT_OF_PROPS,
	    FeatureCatalogue.PARAM_OUTPUT_FORMAT, FeatureCatalogue.PARAM_PACKAGE, FeatureCatalogue.PARAM_PRODUCER,
	    FeatureCatalogue.PARAM_REFERENCE_MODEL_FILENAME_OR_CONSTRING, FeatureCatalogue.PARAM_REFERENCE_MODEL_TYPE,
	    FeatureCatalogue.PARAM_SCOPE, FeatureCatalogue.PARAM_VERSION_DATE, FeatureCatalogue.PARAM_VERSION_NUMBER,
	    FeatureCatalogue.PARAM_XSL_DOCX_FILE, FeatureCatalogue.PARAM_XSL_FO_FILE,
	    FeatureCatalogue.PARAM_XSL_FRAME_HTML_FILENAME, FeatureCatalogue.PARAM_XSL_HTML_FILE,
	    FeatureCatalogue.PARAM_XSL_LOCALIZATION_URI, FeatureCatalogue.PARAM_XSL_RTF_FILE,
	    FeatureCatalogue.PARAM_XSL_TRANSFORMER_FACTORY, FeatureCatalogue.PARAM_XSL_XML_FILE,
	    FeatureCatalogue.PARAM_XSLT_PATH, FeatureCatalogue.PARAM_XSLT_PFAD).collect(Collectors.toSet()));
