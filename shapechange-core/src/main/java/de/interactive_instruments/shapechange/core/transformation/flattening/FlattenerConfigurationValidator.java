...
public class FlattenerConfigurationValidator extends AbstractConfigurationValidator {
    ...
    protected SortedSet<String> allowedParametersWithStaticNames = new TreeSet<>(Stream.of(
	    ...
	    Flattener.PARAM_INHERITANCE_ASSROLE_MINZERO, Flattener.PARAM_INHERITANCE_LINKED_DOC_PAGEBREAK,
	    Flattener.PARAM_KEEP_ORIGINAL_NAME_AS_ALIAS, Flattener.PARAM_KEEP_ORIGINAL_NAME_AS_CODE,
	    Flattener.PARAM_LOWER_CASE_ALIAS_FOR_PROPERTIES, Flattener.PARAM_LOWER_CASE_CODE_FOR_PROPERTIES,
	    Flattener.PARAM_MAX_MULTIPLICITY_THRESHOLD, Flattener.PARAM_MAXOCCURS,
	    ...
	    Flattener.PARAM_UOM_SUFFIX_SEPARATOR, Flattener.PARAM_DIRECT_POSITION_RSID_SUFFIX)
