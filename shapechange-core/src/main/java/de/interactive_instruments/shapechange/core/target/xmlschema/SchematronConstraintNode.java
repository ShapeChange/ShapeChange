...
public abstract class SchematronConstraintNode {
	 ...
	 */
	public abstract SchematronConstraintNode nodeVariableIsBoundTo(
	...
	public static class Logic extends SchematronConstraintNode {
		...
		@Override
		public SchematronConstraintNode nodeVariableIsBoundTo(Declaration vardecl) {
		    return null;
		}
	...
	public static class Empty extends SchematronConstraintNode {
		...
		public XpathFragment translate(BindingContext ctx) {
			...
			SchematronConstraintNode obj = children.getFirst();
				...
				if (!expr.isMultiple()) {
					...
					if (exat1 == null) {
						...
						if (!exat.hasSimpleType()) {
							...
							// construct.
							SchematronConstraintNode sv = exat.children.getFirst();
	...
	public static class PropertyMetadata extends SchematronConstraintNode {
		...
		public XpathFragment translate(BindingContext ctx) {
			...
			SchematronConstraintNode objnode = children.getFirst();
	...
	public static class IfThenElse extends SchematronConstraintNode {
		...
		public XpathFragment translate(BindingContext ctx) {
			...
			// The 3 arguments
			SchematronConstraintNode con = children.getFirst();
	...
	public static class Let extends SchematronConstraintNode {
		...
		public XpathFragment translate(BindingContext ctx) {
			...
			// use of.
			SchematronConstraintNode body = children.getLast();
			letctx = ctx;
