...
public class CodelistDictionariesConfigurationValidator extends AbstractConfigurationValidator {
    ...
    protected SortedSet<String> allowedParametersWithStaticNames = new TreeSet<>(
	    Stream.of(CodelistDictionaries.PARAM_ADD_STYLESHEET_PROCESSING_INSTRUCTION,
		    CodelistDictionaries.PARAM_CODELISTS, CodelistDictionaries.PARAM_DEFINITION_GMLID_TEMPLATE,
		    ...
		    CodelistDictionaries.PARAM_USE_NAME_FOR_BLANK_INITIAL_VALUE).collect(Collectors.toSet()));
