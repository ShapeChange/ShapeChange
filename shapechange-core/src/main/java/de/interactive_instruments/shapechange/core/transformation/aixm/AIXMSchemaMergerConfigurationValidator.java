 ...
 * Germany
 */
package de.interactive_instruments.shapechange.core.transformation.aixm;
 ...
 *
 */
public class AIXMSchemaMergerConfigurationValidator extends AbstractConfigurationValidator {

    protected SortedSet<String> allowedParametersWithStaticNames = new TreeSet<>(
	    Stream.of(AIXMSchemaMerger.PARAM_INPUT_MERGE_AIXM_CORE_TNS).collect(Collectors.toSet()));
