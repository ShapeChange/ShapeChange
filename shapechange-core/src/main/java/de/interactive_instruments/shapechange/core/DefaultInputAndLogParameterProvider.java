...
public class DefaultInputAndLogParameterProvider implements InputAndLogParameterProvider {
    ...
    protected SortedSet<String> allowedInputParametersWithStaticNames = new TreeSet<>(Stream.of("addTaggedValues",
	    ...
	    "kmlReferenceType", "language", "lineEnding", "loadConstraintsForSelectedSchemasOnly",
	    "loadLinkedDocuments", "mainAppSchema", "navigatingNonNavigableAssociationsWhenParsingOcl",
	    "oclConstraintTypeRegex", "onlyDeferrableOutputWrite", "prohibitLoadingClassesWithStatusTaggedValue",
	    "publicOnly", "representTaggedValues", "repositoryFileNameOrConnectionString", "scxmlXsdLocation",
