...
CREATE TABLE featuretype1 (
   ...
   CONSTRAINT fk_featuretype1_roleft1c_fk FOREIGN KEY (roleft1c_fk) REFERENCES featuretype2 ON DELETE CASCADE ON UPDATE CASCADE,
   CONSTRAINT fk_featuretype1_roleft1e_fk FOREIGN KEY (roleft1e_fk) REFERENCES featuretype2 ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE featuretype1_roleft1d (
   ...
   featuretype2_id INTEGER NOT NULL,
   PRIMARY KEY (featuretype1_id, featuretype2_id),
   CONSTRAINT fk_featuretype1_roleft1d_featuretype1_id FOREIGN KEY (featuretype1_id) REFERENCES featuretype1 ON DELETE CASCADE ON UPDATE CASCADE,
   CONSTRAINT fk_featuretype1_roleft1d_featuretype2_id FOREIGN KEY (featuretype2_id) REFERENCES featuretype2 ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE featuretype2 (
   ...
   CONSTRAINT fk_featuretype2_roleft2d_fk FOREIGN KEY (roleft2d_fk) REFERENCES featuretype1 ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE featuretype3_attmultivalue (
   ...
   CONSTRAINT fk_featuretype3_attmultivalue_featuretype3_id FOREIGN KEY (featuretype3_id) REFERENCES featuretype3 ON DELETE CASCADE ON UPDATE CASCADE
);
