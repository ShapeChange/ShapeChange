...
CREATE TABLE featuretype2 (
   ...
   attribute13 bigserial NOT NULL
);
...
CREATE TABLE mydatatype (
   ...
   attribute11 bigserial NOT NULL,
...
ALTER TABLE featuretype2 ADD CONSTRAINT fk_featuretype2_attribute13 FOREIGN KEY (attribute13) REFERENCES myotherdatatype;
...
ALTER TABLE mydatatype ADD CONSTRAINT fk_mydatatype_attribute11 FOREIGN KEY (attribute11) REFERENCES myotherdatatype;
