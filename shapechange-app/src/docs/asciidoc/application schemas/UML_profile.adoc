...
|[[collectionGeometryType]]collectionGeometryType |property | | |A comma-separated list of codes from the GeometryType codelist in ISO 19107:2019. To be set whenever the property type is 'Collection' from ISO 19107:2019, and additional information is needed to specify which element types are expected. The tag can be used to provide that information, so that targets can encode the value type with the appropriate aggregate geometry type. |XML Schema target (and more to be added as needed) |xref:../targets/xml schema/XML_Schema.adoc#MappingIso19107Collection[XmlSchema Target: Mapping Type Collection from ISO 19107:2019]
...
|jsonBaseUri |schema package | |OGC UGAS-2020 Engineering Report |Can be used to define the base of the URI that is used as value of the 'id' field of a JSON Schema file generated by ShapeChange. Takes precedence over the JSON Schema target parameter jsonBaseUri. |JSON Schema target |JSON Schema target parameter xref:../targets/JSON_Schema.adoc#jsonBaseUri[jsonBaseUri]

|jsonDirectory |schema package | |OGC UGAS-2020 Engineering Report |Used to define a subdirectory within the URI that is used as value of the 'id' field of a JSON Schema file generated by ShapeChange. |JSON Schema target | 
