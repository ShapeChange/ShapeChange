...
_de.interactive_instruments.shapechange.core.transformation.profiling.Profiler._
...
----------
<Transformer class="de.interactive_instruments.shapechange.core.transformation.profiling.Profiler" mode="enabled" id="A">
    <parameters>
