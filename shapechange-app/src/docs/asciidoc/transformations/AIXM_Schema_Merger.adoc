...
_de.interactive_instruments.shapechange.core.transformation.aixm.AIXMSchemaMerger_.
...
----------
<Transformer
  class="de.interactive_instruments.shapechange.core.transformation.aixm.AIXMSchemaMerger"
