...
_de.interactive_instruments.shapechange.core.transformation.citygml.CityGMLTransformer_
...
----------
<Transformer
  class="de.interactive_instruments.shapechange.core.transformation.citygml.CityGMLTransformer"
