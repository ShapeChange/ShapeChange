...
[width="100%",cols="1,9"]
|===
|1 |Verify that your Java Runtime Environment fulfills the Java version requirements defined in the xref:./Release_Notes.adoc[Release Notes] (or is of an even higher version).

|2 |https://github.com/ShapeChange/ShapeChange/releases/download/{project-version}/ShapeChange-{project-version}.zip[Download ShapeChange (all platforms; version {project-version})] xref:./Release_Notes.adoc[Release Notes]
