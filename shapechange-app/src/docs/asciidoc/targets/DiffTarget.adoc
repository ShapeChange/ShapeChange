...
Examples of XML encoded model differences can be found in the unit tests of this target, the resources of which are located at https://github.com/ShapeChange/ShapeChange/tree/master/shapechange-app/src/integrationtests/diffTarget.
