...
The ShapeChange configuration and results of that test are available https://github.com/ShapeChange/ShapeChange/tree/master/src/integrationtests/ldproxy2/fragmentsConcatCoalesce[here], 
while the model is available
https://github.com/ShapeChange/ShapeChange/tree/master/src/integrationtests/sql/sqlEncodingInfos[here].
