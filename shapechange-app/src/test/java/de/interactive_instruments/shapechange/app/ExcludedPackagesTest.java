...
public class ExcludedPackagesTest extends WindowsBasicTest {
	...
	public void testFromEA() {
		...
		multiTest("src/integrationtests/excludedPackages/fromEA/test.xml",
				new String[] { "xsd" }, "testResults/excludedPackages/fromEA",
				"src/integrationtests/excludedPackages/fromEA/reference");
	}

	@Test
	public void testFromSCXML() {

		multiTest("src/integrationtests/excludedPackages/fromSCXML/test.xml",
				new String[] { "xsd" }, "testResults/excludedPackages/fromSCXML",
				"src/integrationtests/excludedPackages/fromSCXML/reference");
	}
}
