...
public class OutputProcessingTest extends BasicTestSCXML {
	...
	multiTest("src/integrationtests/outputProcessing/multipleSchemas/testEA_outputProcessing_multipleSchemas.xml",
		new String[] { "html", "ttl", "sql", "xsd" }, "testResults/outputProcessing/multipleSchemas/results",
		"src/integrationtests/outputProcessing/multipleSchemas/reference");
    }

    @Test
    public void testOutputProcessing_singleSchema() {

	multiTest("src/integrationtests/outputProcessing/singleSchema/testEA_outputProcessing_singleSchema.xml",
		new String[] { "html", "ttl", "sql", "xsd" }, "testResults/outputProcessing/singleSchema/results",
		"src/integrationtests/outputProcessing/singleSchema/reference");
    }
}