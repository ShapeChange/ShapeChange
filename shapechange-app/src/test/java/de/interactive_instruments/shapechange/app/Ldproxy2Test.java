...
public class Ldproxy2Test extends BasicTestSCXML {
	...
	multiTest("src/integrationtests/ldproxy2/basic/test_ldproxy2.xml", new String[] { "yaml", "yml" },
		"testResults/ldproxy2/basic/results", "src/integrationtests/ldproxy2/basic/reference/results");
    }

    @Test
    public void test_ldproxy2_titleAttribute() {

	multiTest("src/integrationtests/ldproxy2/titleAttribute/test_ldproxy2.xml", new String[] { "yaml", "yml" },
		"testResults/ldproxy2/titleAttribute/results",
	...
	multiTest("src/integrationtests/ldproxy2/queryables/test_ldproxy2.xml", new String[] { "yaml", "yml" },
		"testResults/ldproxy2/queryables/results",
	...
	multiTest(
		"src/integrationtests/ldproxy2/foreignKeyColumnSuffixCodelist/test_foreignKeyColumnSuffixCodelist.xml",
	...
	multiTest(
		"src/integrationtests/ldproxy2/associativeTablesWithSeparatePkField/test_associativeTablesWithSeparatePkField.xml",
		new String[] { "yaml", "yml", "sql" },
		"testResults/ldproxy2/associativeTablesWithSeparatePkField/results",
	...
	multiTest("src/integrationtests/ldproxy2/gmlOutput/test_ldproxy2_gmlOutput.xml", new String[] { "yaml", "yml" },
		"testResults/ldproxy2/gmlOutput/results", "src/integrationtests/ldproxy2/gmlOutput/reference/results");
    }
	...
	multiTest("src/integrationtests/ldproxy2/coretable/test_ldproxy2_coretable.xml", new String[] { "yaml", "yml" },
		"testResults/ldproxy2/coretable/results", "src/integrationtests/ldproxy2/coretable/reference/results");
    }
	...
	multiTest("src/integrationtests/ldproxy2/embedding/test_ldproxy2_embedding.xml", new String[] { "yaml", "yml" },
		"testResults/ldproxy2/embedding/results", "src/integrationtests/ldproxy2/embedding/reference/results");
    }
    ...
    @Test
    public void test_ldproxy2_tileProvider() {
	...
	multiTest("src/integrationtests/ldproxy2/storedQueries/test_ldproxy2_storedQueries.xml",
		new String[] { "yaml", "yml", "json" }, "testResults/ldproxy2/storedQueries/results",
	...
	multiTest("src/integrationtests/ldproxy2/measure/test_ldproxy2Measure.xml", new String[] { "yaml", "yml" },
		"testResults/ldproxy2/measure/results", "src/integrationtests/ldproxy2/measure/reference/results");
    }
}
