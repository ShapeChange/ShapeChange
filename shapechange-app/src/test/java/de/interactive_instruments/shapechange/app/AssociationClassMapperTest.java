...
public class AssociationClassMapperTest extends BasicTestSCXML {
	...
	public void testGML33BasedTransformationOfAssociationClasses() {
		 ...
		 */
		multiTest("src/integrationtests/associationClassMapper/basic/testEA_associationClassMapper.xml",
				new String[] { "xsd" },
				"testResults/associationClassMapper/basic",
				"src/integrationtests/associationClassMapper/basic/reference");
	}
