...
import de.interactive_instruments.shapechange.app.inputtransformertest.InputTransformerTestResourceConverter;

/**
 * @author Johannes Echterhoff (echterhoff at interactive-instruments dot de)
 *
 */
public class BasicTestInputTransformer extends WindowsBasicTest {

    InputTransformerTestResourceConverter converter = new InputTransformerTestResourceConverter();
	...
	try {
	    pathToRelevantConfig = converter.updateEaInputTransformationTestResources(configPath);
	} catch (Exception e) {
	    e.printStackTrace();
	    fail("Exception occurred while updating test resources.", e);
	    return;
	}
	...
	String pathToRelevantConfig;
	try {
	    pathToRelevantConfig = converter.updateEaInputTransformationTestResources(config);
	} catch (Exception e) {
	    e.printStackTrace();
	    fail("Exception occurred while updating test resources.", e);
	    return;
