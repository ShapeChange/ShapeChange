...
public class CommonTransformerTest extends BasicTestSCXML {
	...
	multiTest(
		"src/integrationtests/commonTransformer/setTaggedValues/testEA_common_settaggedvalues.xml",
		new String[] { "xsd" }, "testResults/commonTransformer/setTaggedValues",
		"src/integrationtests/commonTransformer/setTaggedValues/reference");
    }
