...
public class VariousFunctionalityTest extends BasicTestSCXML {
	...
	multiTest("src/integrationtests/variousFunctionality/notEncoded/testEA_notEncoded.xml",
		new String[] { "xsd", "json", "sql" }, "testResults/variousFunctionality/notEncoded",
		"src/integrationtests/variousFunctionality/notEncoded/reference");
    }
	...
	multiTest(
		"src/integrationtests/variousFunctionality/loadingWithProhibitedStatus/testEA_loadingWithProhibitedStatusSetting.xml",
		new String[] { "xsd", "html" }, "testResults/loadingWithProhibitedStatusSetting/results",
		"src/integrationtests/variousFunctionality/loadingWithProhibitedStatus/reference");
    }
	...
	executeAndError(
		"src/integrationtests/variousFunctionality/basicModelValidation/strict_fail/testEA_basicModelValidation_strict_fail.xml",
